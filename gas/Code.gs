...
function doPost(e) {
  ...
  auditLog:                payload.auditLog                || [],   // ←監査ログ（誰が・いつ・何を変更したか）
  posCategories:           payload.posCategories           || [],   // ←レジ：カテゴリー
...
'HIRAYAMA,FUKUSHIMA,NAKAO,YOKOTA,KAWASHIMA,MATSUNAGA,SHINODA,TAKAYAMA,UMEDA,KANAZAWA,'+
'OTANI,OOTANI,KUBOTA,NODA,KOYAMA,MASUDA,ANDO,SEKINE,SHOJI,IGARASHI,'+
'KONO,KATO,MOMOSE,NEGISHI,AOYAMA,KOSAKA,KANEDA,NAGATA,SEKI,SHIRAI').split(',');
...
'MASAHIRO,KIYOSHI,TADASHI,YASUO,NOBUO,TERUO,KATSUMI,FUMIKO,ETSUKO,JUNKO,'+
'HINA,RENA,RIKO,MOMOKA,NANAMI,YUINA,KOTONE,ICHIKA').split(',');
